...
do {
    try{
        ...
        $kvSecretName = Get-AutomationVariable -Name 'DW_CONNT_STRG_KV_SCRT_NM'
        ...
        $procParams = "exec CTRLDB.Sp_InitializeProcess '$jobName','$cubeName',1,'$appName','$runId',NULL,NULL"
